...
#define STRING_CONFIG_H_AUTHOR "(amoratinos, Anet A6)" // Who made the changes.
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 101.5296, 97.4510, 401.9188, 96 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -10.6, -53, -10.5 }
